...
class yolor():
    ...
    def detect(self, frame):
        ...
        for i in indices:
            ...
            cv2.rectangle(frame, (box[0], box[1]), (box[0] + box[2], box[1] + box[3]), (0, 0, 255), thickness=3)
            cv2.putText(frame, self.classes[classIds[i]]+': '+str(round(confidences[i], 3)), (box[0], box[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), thickness=3)
        return frame
...
if __name__=='__main__':
    ...
    net = yolor('yolov5s.onnx', 0.5, 0.5, 0.5)
